...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewVO> {
    ...
    @Override
    public boolean isValid(ClienteNewVO objDto, ConstraintValidatorContext context) {
